...
public:
   ...
   const bool IsZeDMDEnforceStreaming() { return m_zedmdEnforceStreaming; }
   void SetZeDMDEnforceStreaming(bool zedmdEnforceStreaming) { m_zedmdEnforceStreaming = zedmdEnforceStreaming; }
