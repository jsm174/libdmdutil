...
cp third-party/runtime-libs/macos/x64/libcargs.dylib ${SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
cp -a third-party/runtime-libs/macos/x64/libserialport.{dylib,*.dylib} ${SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
cp -a third-party/runtime-libs/macos/x64/libsockpp.{dylib,*.dylib} ${SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
cp -a build/libzedmd.{dylib,*.dylib} ${SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
...
cp -a build/libserum.{dylib,*.dylib} ${SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
cd "${SOURCE_ROOT}/external"
...
cp -a build/libpupdmd.{dylib,*.dylib} ${SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
cd "${SOURCE_ROOT}/external"
...
cp -a build/libvni.{dylib,*.dylib} ${SOURCE_ROOT}/third-party/runtime-libs/macos/x64/
cd "${SOURCE_ROOT}/external"
