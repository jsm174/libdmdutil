...
cp third-party/runtime-libs/android/arm64-v8a/libsockpp.so ${SOURCE_ROOT}/third-party/runtime-libs/android/arm64-v8a/
cp build/libzedmd.so ${SOURCE_ROOT}/third-party/runtime-libs/android/arm64-v8a/
...
cp build/libserum.so ${SOURCE_ROOT}/third-party/runtime-libs/android/arm64-v8a/
cd "${SOURCE_ROOT}/external"
...
cp build/libpupdmd.so ${SOURCE_ROOT}/third-party/runtime-libs/android/arm64-v8a/
cd "${SOURCE_ROOT}/external"
...
cp build/libvni.so ${SOURCE_ROOT}/third-party/runtime-libs/android/arm64-v8a/
cd "${SOURCE_ROOT}/external"
