...
LIBZEDMD_SHA=a68ea0999831e989d3b3ca705b3ad0f895a6dc2c
...
cp build/libzedmd.so.0.4.0 ../../third-party/runtime-libs/linux/x64
cd ..
...
cmake -DPLATFORM=linux -DARCH=x64 -DBUILD_SHARED=ON -DBUILD_STATIC=OFF -DCMAKE_BUILD_TYPE=${BUILD_TYPE} -B build
cmake --build build -- -j${NUM_PROCS}
cp build/libserum.so.1.6.2 ../../third-party/runtime-libs/linux/x64
cd ..