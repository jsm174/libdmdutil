...
cp -a third-party/build-libs/ios/arm64/libsockpp.a ${SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cp build/libzedmd.a ${SOURCE_ROOT}/third-party/build-libs/ios/arm64/
...
cp build/libserum.a ${SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd "${SOURCE_ROOT}/external"
...
cp build/libpupdmd.a ${SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd "${SOURCE_ROOT}/external"
...
cp build/libvni.a ${SOURCE_ROOT}/third-party/build-libs/ios/arm64/
cd "${SOURCE_ROOT}/external"
